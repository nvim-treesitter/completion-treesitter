...
augroup CompletionTS
	autocmd CursorHold *.c,*.py,*.lua,*.ts call completion_treesitter#highlight_usages()
	autocmd CursorMoved *.c,*.py,*.lua,*.ts call nvim_buf_clear_namespace(0, g:completion_ts_ns, 0, -1)
	autocmd InsertEnter *.c,*.py,*.lua,*.ts call nvim_buf_clear_namespace(0, g:completion_ts_ns, 0, -1)
augroup END
