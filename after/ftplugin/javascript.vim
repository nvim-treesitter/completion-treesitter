...
let b:completion_def_query = [
      ...
      \'(function_declaration parameters: (formal_parameters (identifier) @def @v))',
      \'(function_declaration parameters: (formal_parameters (identifier) @def @v))',
      \'(arrow_function parameters: (formal_parameters (identifier) @def @v))',
      \'(arrow_function parameters: (formal_parameters (identifier) @def @v))',
      \'(method_definition parameters: (formal_parameters (identifier) @def @v))',
      \'(method_definition parameters: (formal_parameters (identifier) @def @v))',
